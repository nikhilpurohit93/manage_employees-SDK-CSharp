...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://mg-eval-test.apigee.net/demo/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://mg-eval-test.apigee.net/demo/v1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://mg-eval-test.apigee.net/demo/v1")
        {
